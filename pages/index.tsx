...
export default function Home() {
  return (
    <div>
      <HeaderBar />
      <section id="about" aria-label="About Colin Zhou">
        <Introduction />
...
Cluster Analytics`,
      ...
      <section id="classwork" aria-label="Classwork">
      ...
      {/* Visible agent resource download section */}
      <section
        id="for-agents"
        aria-label="For AI Agents"
        className="mx-auto max-w-2xl px-6 py-10 mb-10"
      >
        <h2 className="text-2xl sm:text-3xl font-extrabold dark:text-blue-300 text-center mb-2">
          🤖 For AI Agents
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <a
            ...
            className="flex flex-col items-center gap-2 rounded-xl border border-indigo-400/40 bg-gray-800 p-5 hover:border-indigo-400 hover:bg-gray-700 transition-all duration-200 group"
          >
            ...
            <span className="text-xs text-gray-400 text-center">
              Full-site index &amp; instructions for AI agents
            </span>
          </a>
          <a
            href="/v3/resume.md"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center gap-2 rounded-xl border border-cyan-400/40 bg-gray-800 p-5 hover:border-cyan-400 hover:bg-gray-700 transition-all duration-200 group"
          >
            <span className="text-3xl">📝</span>
            ...
            <span className="text-xs text-gray-400 text-center">
              Full resume in clean Markdown format
            </span>
          </a>
          <a
            href="/v3/projects.json"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center gap-2 rounded-xl border border-green-400/40 bg-gray-800 p-5 hover:border-green-400 hover:bg-gray-700 transition-all duration-200 group"
          >
            <span className="text-3xl">🗂️</span>
            <span className="font-semibold text-white group-hover:text-green-300 transition-colors">
              projects.json
            </span>
            <span className="text-xs text-gray-400 text-center">
